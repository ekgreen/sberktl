...
create table if not exists reserve.park(
    id          uuid         constraint park_pk primary key default uuid_generate_v5(),
...
create table if not exists reserve.gamekeeper(
    id          uuid         constraint gamekeeper_pk primary key default uuid_generate_v5(),
    name        varchar(128) not null,
...
create table if not exists reserve.zone(
    id              uuid         constraint zone_pk primary key default uuid_generate_v5(),
    code            int          not null,
    name            varchar(128) not null,
    description     varchar(512),
...
create table if not exists reserve.chip(
    id          uuid         constraint chip_pk primary key default uuid_generate_v5(),
...
create table if not exists reserve.animal(
    id      uuid         constraint animal_pk primary key default uuid_generate_v5(),
